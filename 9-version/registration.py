...
- logging on Telegram without support script
- providing revoke tokens
- supporting server errors and user mistakes
- storing significant events on a log file that can be used as database on any software capable of reading csv
'''
