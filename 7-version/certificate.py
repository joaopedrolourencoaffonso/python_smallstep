...
--> ''');
        ...
        if str(response.text) == "1111":
            ...
            This means that if there is no action between one popen and another, there is a chance that  
            the second popen will activate before the first ends, like it did in version 3. I don't like 
            these sleeps, but at the moment they keep things running, plus the jwt lasts 5 min, so we're
            in the safe zone.
            '''
